...
_SIGNALS: list[tuple[str, str, float]] = [
    ...
    (r"\b(i ?'?d|i would|would happily|happy to|willing to|gladly)\s+pay\b", "payment", 0.95),
    (r"\btake my money\b", "payment", 0.95),
    (r"\bshut up and take\b", "payment", 0.95),
    (r"\b(i ?'?d|i would)\s+(buy|subscribe to)\b", "payment", 0.9),
